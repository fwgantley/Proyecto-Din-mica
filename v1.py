...
by
Moz
for YouTube changel logMaker360 for this video: https: // www.youtube.com / watch?v = PNbsyHocM2U
21 - 04 - 2017
...
above
with modification of writing the data to a CSV.file:
# Importeer Adafruit DHT bibliotheek.
# time.strftime("%I:%M:%S")
import Adafruit_DHT
import time
